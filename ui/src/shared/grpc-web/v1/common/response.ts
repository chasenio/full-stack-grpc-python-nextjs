...
// @generated from protobuf file "v1/common/response.proto" (package "proto.v1.common", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message proto.v1.common.ErrorResponse
 */
export interface ErrorResponse {
     ...
     * 状态码
     *
     * @generated from protobuf field: proto.v1.common.Code code = 3;
     */
    code: Code;
}
/**
 * 状态码
 *
 * @generated from protobuf enum proto.v1.common.Code
 */
export enum Code {
    /**
     * 无效状态码
...
class ErrorResponse$Type extends MessageType<ErrorResponse> {
    constructor() {
        super("proto.v1.common.ErrorResponse", [
            { no: 1, name: "message", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "violations", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Violation },
            { no: 3, name: "code", kind: "enum", T: () => ["proto.v1.common.Code", Code, "CODE_"] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* repeated buf.validate.Violation violations */ 2:
                    ...
                    break;
                case /* proto.v1.common.Code code */ 3:
...
/**
 * @generated MessageType for protobuf message proto.v1.common.ErrorResponse
 */
